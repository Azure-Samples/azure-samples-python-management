...
# Getting started - Managing Recovery Services using Azure Python SDK

These code samples will show you how to manage Recovery Services using Azure SDK for Python.
...
### Compute
* Using the Azure SDK for Python - Recovery Services Management Library [azure-mgmt-recoveryservices](https://pypi.org/project/azure-mgmt-recoveryservices/) for the [Azure Recovery Services API](https://docs.microsoft.com/en-us/rest/api/recoveryservices/)
...
2.  Install the dependencies using pip.
    ...
    ```
    cd azure-samples-python-management/samples/recoveryservices
