...
products:
- azure
description: "These code samples will show you how to manage Resource Graph using Azure SDK for Python."
urlFragment: resourcegraph
---

# Getting started - Managing Resource Graph using Azure Python SDK

These code samples will show you how to manage Resource Graph using Azure SDK for Python.
...
2.  Install the dependencies using pip.
    ...
    ```
    cd azure-samples-python-management/samples/resourcegraph
