...
products:
- azure
description: "These code samples will show you how to manage Logic using Azure SDK for Python."
urlFragment: logic
---

# Getting started - Managing Logic using Azure Python SDK

These code samples will show you how to manage Logic using Azure SDK for Python.
...
### Logic
* [] Using the Azure SDK for Python - Logic Management Library [azure-mgmt-logic](https://pypi.org/project/azure-mgmt-logic/) for the [Logic API](https://docs.microsoft.com/en-us/rest/api/logic/)
...
2.  Install the dependencies using pip.
    ...
    ```
    cd azure-samples-python-management/samples/logic
