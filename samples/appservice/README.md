...
products:
- azure
description: "These code samples will show you how to manage App Service using Azure SDK for Python."
urlFragment: appservice
---

# Getting started - Managing App Service using Azure Python SDK

These code samples will show you how to manage App Service using Azure SDK for Python.
...
### App Service
* Using the Azure SDK for Python - App Service Management Library [azure-mgmt-appservice](https://pypi.org/project/azure-mgmt-appservice/) for the [Azure App Service API](https://docs.microsoft.com/en-us/rest/api/appservice/)
...
2.  Install the dependencies using pip.
    ...
    ```
    cd azure-samples-python-management/samples/appservice
...
1. `python manage_app_service_plan.py`
