...
products:
- azure
description: "These code samples will show you how to manage IoT Hub Device Provisioning Service using Azure SDK for Python."
urlFragment: iothubprovisioningservices 
---

# Getting started - Managing IoT Hub Device Provisioning Service using Azure Python SDK

These code samples will show you how to manage IoT Hub Device Provisioning Service using Azure SDK for Python.
...
* Using the Azure SDK for Python - IoT Hub Device Provisioning Service Management Library [azure-mgmt-iothubprovisioningservices](https://pypi.org/project/azure-mgmt-iothubprovisioningservices/) for the [Azure IoT Hub Device Provisoining Service API](https://docs.microsoft.com/en-us/rest/api/iot-dps/)
...
2.  Install the dependencies using pip.
    ...
    ```
    cd azure-samples-python-management/samples/iothubprovisioningservices
