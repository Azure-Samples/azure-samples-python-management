...
These code samples will show you how to manage Storage using Azure SDK for Python.
...
### Storage
* Using the Azure SDK for Python - Storage Manamgement Library [azure-mgmt-storage](https://pypi.org/project/azure-mgmt-storage/) for the [Storage API](https://docs.microsoft.com/en-us/rest/api/storagerp/)
