...
products:
- azure
description: "These code samples will show you how to manage Test Base resouces using Azure SDK for Python."
urlFragment: testbase
---

# Getting started - Managing Test Base resouces using Azure Python SDK

These code samples will show you how to manage Test Base resouces using Azure SDK for Python.
...
### Test Base for M365
* Using the Azure SDK for Python - Test Base Management Library [azure-mgmt-testbase](https://pypi.org/project/azure-mgmt-testbase/) for the [Test Base for M365 REST API](https://docs.microsoft.com/en-us/rest/api/)
...
2.  Install the dependencies using pip.
    ...
    ```
    cd azure-samples-python-management/samples/testbase
...
1. `python manage_testbase_account.py`
