...
products:
- azure
description: "These code samples will show you how to manage Reservations using Azure SDK for Python."
urlFragment: reservations
---

# Getting started - Managing Reservations using Azure Python SDK

These code samples will show you how to manage Reservations using Azure SDK for Python.
...
### Reservations
* [] Using the Azure SDK for Python - Reservations Management Library [azure-mgmt-reservations](https://pypi.org/project/azure-mgmt-reservations/) for the [Resource Health API](https://docs.microsoft.com/en-us/rest/api/reservations/)
...
2.  Install the dependencies using pip.
    ...
    ```
    cd azure-samples-python-management/samples/reservations
...
1. `python manage_reservations_list.py`
