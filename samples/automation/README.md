...
products:
- azure
description: "These code samples will show you how to manage Automation using Azure SDK for Python."
urlFragment: automation
---

# Getting started - Managing Automation using Azure Python SDK

These code samples will show you how to manage Automation using Azure SDK for Python.
...
### Automation
* Using the Azure SDK for Python - Automation Management Library [azure-mgmt-automation](https://pypi.org/project/azure-mgmt-automation/) for the [Azure Automation API](https://docs.microsoft.com/en-us/rest/api/automation/)
...
2.  Install the dependencies using pip.
    ...
    ```
    cd azure-samples-python-management/samples/automation
