...
### Eventhub
* [] Using the Azure SDK for Python - Eventhub Management Library [azure-mgmt-eventhub](https://pypi.org/project/azure-mgmt-eventhub/) for the [Eventhub API](https://docs.microsoft.com/en-us/rest/api/eventhub/)
...
1. `python aio/manage_namespace_async.py`
