...
products:
- azure
description: "These code samples will show you how to manage Container Service using Azure SDK for Python."
urlFragment: containerservice
---

# Getting started - Managing Container Service using Azure Python SDK

These code samples will show you how to manage Container Service using Azure SDK for Python.
...
2.  Install the dependencies using pip.
    ...
    ```
    cd azure-samples-python-management/samples/containerservice
