...
products:
- azure
description: "These code samples will show you how to manage Batch using Azure SDK for Python."
urlFragment: batch
---

# Getting started - Managing Batch using Azure Python SDK

These code samples will show you how to manage Batch using Azure SDK for Python.
...
### Batch
* Using the Azure SDK for Python - Batch Management Library [azure-mgmt-batch](https://pypi.org/project/azure-mgmt-batch/) for the [Batch Management API](https://docs.microsoft.com/en-us/rest/api/batchmanagement/)
...
2.  Install the dependencies using pip.
    ...
    ```
    cd azure-samples-python-management/samples/batch
...
1. `python manage_application.py`
