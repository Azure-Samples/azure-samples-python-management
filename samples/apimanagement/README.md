...
products:
- azure
description: "These code samples will show you how to manage Apimanagement using Azure SDK for Python."
urlFragment: apimanagement
---

# Getting started - Managing Apimanagement using Azure Python SDK

These code samples will show you how to manage Apimanagement using Azure SDK for Python.
...
### Apimanagement
* [] Using the Azure SDK for Python - Apimanagement Management Library [azure-mgmt-apimanagement](https://pypi.org/project/azure-mgmt-apimanagement/) for the [Apimanagement API](https://docs.microsoft.com/en-us/rest/api/apimanagement/)
...
2.  Install the dependencies using pip.
    ...
    ```
    cd azure-samples-python-management/samples/apimanagement
