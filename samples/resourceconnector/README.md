...
products:
- azure
description: "These code samples will show you how to manage Service Linker using Azure SDK for Python."
urlFragment: resourceconnector
---

# Getting started - Managing Service Linker using Azure Python SDK

These code samples will show you how to manage Service Linker using Azure SDK for Python.
...
### Service Linker
* Using the Azure SDK for Python - Service Linker Management Library [azure-mgmt-resourceconnector](https://pypi.org/project/azure-mgmt-resourceconnector/) for the [Azure Service Linker API](https://docs.microsoft.com/en-us/rest/api/serviceconnector/)
...
2.  Install the dependencies using pip.
    ...
    ```
    cd azure-samples-python-management/samples/resourceconnector
