...
products:
- azure
description: "These code samples will show you how to manage IoT Hub  using Azure SDK for Python."
urlFragment: iothub 
---
...
### IoT Hub
* Using the Azure SDK for Python - IoT Hub Management Library [azure-mgmt-iothub](https://pypi.org/project/azure-mgmt-iothub/) for the [Azure IoT Hub API](https://docs.microsoft.com/en-us/rest/api/iothub/)
