...
products:
- azure
description: "These code samples will show you how to manage Azure Lab Services using Azure SDK for Python."
urlFragment: labservices
---

# Getting started - Managing Azure Lab Services using Azure Python SDK

These code samples will show you how to manage Azure Lab Services using Azure SDK for Python.
...
### Azure Lab Servicess
* [] Using the Azure SDK for Python - Lab Services Management Library [azure-mgmt-labservices](https://pypi.org/project/azure-mgmt-labservices/) for the [Lab Services API](https://docs.microsoft.com/en-us/rest/api/labservices/labs)
...
2.  Install the dependencies using pip.
    ...
    ```
    cd azure-samples-python-management/samples/labservices
...
1. `python manage_labservices.py`
